...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"),"Shreya");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"),"Parikh");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Email']"),"sbp1309@gmail.com");
        Thread.sleep(1000);
        selectByVisibleTextFromDropDown(By.xpath("//select[@id='BillingNewAddress_CountryId']"),"India");
        Thread.sleep(1000);
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"),"London");

        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Address1']"),"429,Kenton Road");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']"),"HA3 0XY");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"),"0765432189");
        ...
        sendTextToElement(By.id("CardholderName"),"S Par");
        ...
        sendTextToElement(By.xpath("//input[@id='CardCode']"),"954");
